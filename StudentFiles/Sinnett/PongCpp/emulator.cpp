...
extern unsigned char * screen_pixels;
...
static void CreateScreenMemory()
{
     ...
     handle= CreateDIBSection(NULL, (BITMAPINFO*)&bitmap, DIB_RGB_COLORS, (void**)&screen_pixels, NULL, 0);
